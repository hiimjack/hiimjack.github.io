...
Nel tempo libero mi piace leggere romanzi di fantascienza e narrativa tecnologica, in particolare saghe come _Fondazione_. Ascolto spesso musica mentre lavoro o mi rilasso, e passo volentieri il tempo in montagna. Mi entusiasma anche sperimentare nuove tecnologie e soluzioni, esplorando strumenti e approcci che possano semplificare o migliorare il modo in cui lavoriamo.
...
• Progettazione e implementazione di un sistema di grid computing utilizzando Sun Grid Engine (SGE).

• Sviluppo di librerie per l'automazione di VMware vSphere SDK.
...
💼 Tecnico Superiore in Sviluppo Web e Cloud

📍 Fondazione ITS per le Tecnologie dell’Informazione e della Comunicazione, Pordenone (PN)

🕖 2017 – 2019

• Focus su sviluppo di applicazioni web, piattaforme cloud (PaaS/SaaS) e virtualizzazione.

• Sviluppo di progetti di gruppo incentrati sui principi Agile e DevOps.

---

💼 Computer Science (L-31)

📍 Università di Udine, Udine (UD)
